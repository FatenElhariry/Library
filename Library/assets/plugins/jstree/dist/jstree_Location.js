                ...
                "remove": {
                    ...
                    "action": function (data) {
                        ...
                        if (Math.floor(id) == id && $.isNumeric(id)) {
                            ...
                            var Data = { 'id': id };
                            $.ajax({
                                url: ROOT + "Manage/RemoveLocation",
                                ...
                                success: function (e) {
                                    ...
                                    if (e == 1) {
                                        ...
                                        $("#Notification_BTN_Action").attr("title", "إدارة الاماكن الجغرافية");
                                        $("#Notification_BTN_Action").attr("msg", "فشل الحذف, هذا المكان يحتوى على أماكن اخرى بداخله");
