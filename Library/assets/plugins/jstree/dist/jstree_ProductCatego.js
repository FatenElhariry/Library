                    ...
                    "action": function (data) {
                        ...
                        if (Math.floor(id) == id && $.isNumeric(id)) {
                            ...
                            if (id == "1" || id == "2") {
                                ...
                                $("#Notification_BTN_Action").attr("title", "إدارة تصنيفات المُنتجات");
                                $("#Notification_BTN_Action").attr("msg", "لا يمكنك حذف هذا التصنيف, تصنيف أجهزه وتصنيف إكسسوارات غير مسموح بحذفهم لكن يمكنك التعديل على بياناتهم");
                                $("#Notification_BTN_Action").click();
                                return;
                            }
                            var Data = { 'id': id };
                            $.ajax({
                                url: ROOT + "Manage/RemoveCat",
                                ...
                                success: function (e) {
                                    ...
                                    if (e == 1) {
                                        ...
                                        $("#Notification_BTN_Action").attr("ntype", "error");
                                        $("#Notification_BTN_Action").attr("title", "إدارة تصنيفات المُنتجات");
                                        $("#Notification_BTN_Action").attr("msg", "فشل الحذف, هذا التصنيف يحتوى على تصنيفات اخرى بداخله");
                                        $("#Notification_BTN_Action").click();
                                    }
                                    else if (e == 3) {
                                        $("#Notification_BTN_Action").attr("ntype", "error");
                                        $("#Notification_BTN_Action").attr("title", "إدارة تصنيفات المُنتجات");
                                        $("#Notification_BTN_Action").attr("msg", "فشل الحذف, هذا النوع يحتوى على منتجات بداخله, قم بحذف المنتجات اولا");
                                        $("#Notification_BTN_Action").click();
                                    }
                                    else if (e == -1) {
                                        $("#Notification_BTN_Action").attr("ntype", "error");
