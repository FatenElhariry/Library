        ...
        items: function (o, cb) { // Could be an object directly
            return {
                ...
                "remove": {
                    ...
                    "action": function (data) {
                        ...
                        if (Math.floor(id) == id && $.isNumeric(id)) {
                            var ROOT = $("#ROOTContentURL").val();
                            var Data = { 'id': id };
                            $.ajax({
                                url: ROOT + "Manage/RemoveSeries",
                                ...
                                success: function (e) {
                                    ...
                                    if (e == 1) {
                                        ...
                                        $("#Notification_BTN_Action").attr("ntype", "error");
                                        $("#Notification_BTN_Action").attr("title", "إدارة مسلسلات التطبيق");
                                        $("#Notification_BTN_Action").attr("msg", "فشل الحذف, هذا المسلسل يحتوى على فيديوهات بداخله");
                                        $("#Notification_BTN_Action").click();
                                        $(".ContinueRemoveSeries").attr("name", id);
                                        $("#MYPOPUPREMOVEseries").click();
                                    }
                                    else if (e == 3) {
                                        $("#Notification_BTN_Action").attr("ntype", "error");
                                        $("#Notification_BTN_Action").attr("title", "إدارة مسلسلات التطبيق");
                                        $("#Notification_BTN_Action").attr("msg", "فشل الحذف, هذا المسلسل مربوط بتطبيقات");
                                        $("#Notification_BTN_Action").click();
                                        $(".ContinueRemoveSeries").attr("name", id);
                                        $("#MYPOPUPREMOVEseries").click();
                                    }
                                        ...
                                        $("#Notification_BTN_Action").attr("ntype", "error");
                                        $("#Notification_BTN_Action").attr("title", "إدارة مسلسلات التطبيق");
                                        $("#Notification_BTN_Action").attr("msg", "فشل الحذف, هذا المسلسل يحتوى على فيديوهات بداخله ومربوط بتطبيقات");
                                        $("#Notification_BTN_Action").click();
                                        $(".ContinueRemoveSeries").attr("name", id);
                                        $("#MYPOPUPREMOVEseries").click();
                                    }
                                        ...
                                        $("#Notification_BTN_Action").attr("ntype", "error");
                                        $("#Notification_BTN_Action").attr("title", "إدارة مسلسلات التطبيق");
                                        $("#Notification_BTN_Action").attr("msg", "فشل الحذف, حدث خطأ اثناء الحذف. من فضلك قم بإبلاغ ادمن النظام");
                                        $("#Notification_BTN_Action").click();
                                        $(".ContinueRemoveSeries").attr("name", id);
                                        $("#MYPOPUPREMOVEseries").click();
                                    }
                ...
                "EditData": {
                    ...
                    "separator_after": false,
                    "_disabled": false, //(this.check("rename_node", data.reference, this.get_parent(data.reference), "")),
                    "label": "تعديل بيانات المسلسل",
                    "action": function (data) {
                        var inst = $.jstree.reference(data.reference),
							obj = inst.get_node(data.reference);

                        var t1 = $("#sample_2").DataTable();
                        var t2 = $("#sample_1").DataTable();

                        t1.search(obj.text).draw();
                        t2.search(obj.text).draw();

                        $(".LocationsEditBTN[name='" + obj.id + "']").click();
                ...
                "EditVideoData": {
                    ...
                    "action": function (data) {
                        ...
                        $(".ManageSeriesVideosClass[name='" + obj.id + "']").click();
